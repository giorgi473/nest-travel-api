...
//   NotFoundException,
//   BadRequestException,
//   InternalServerErrorException, // ✅ დამატებულია
//   Logger,
// } from '@nestjs/common';
// import { InjectRepository } from '@nestjs/typeorm';
// import { Repository } from 'typeorm';
...
//       // ❗❗❗ კრიტიკული ცვლილება: შეცდომების კლასიფიკაცია 502-ის თავიდან ასაცილებლად
//       if (
//         error instanceof BadRequestException ||
//         error instanceof NotFoundException
//       ) {
...
//             );
//             // შეცდომას არ ვაგდებთ, რადგან ახალი ატვირთვა უფრო მნიშვნელოვანია
//           }
//         }
...
//           );
//           // ვაგრძელებთ წაშლას, თუნდაც Cloudinary-მ ვერ წაშალოს
//         }
//       }
